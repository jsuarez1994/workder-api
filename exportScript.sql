...
create table users (id bigint not null, create_at date, update_at date, activated bit, email varchar(255), name varchar(255), password varchar(255), path_photo varchar(255), surname varchar(255), id_position bigint, id_rol bigint, primary key (id))  ;
